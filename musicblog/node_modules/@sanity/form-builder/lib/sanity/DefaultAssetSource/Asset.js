...
class Asset extends _react.default.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "handleDeleteAsset", asset => {
      ...
      return _legacyParts.client.delete(asset._id).then(() => {
        this.setState({
          isDeleting: false
        });
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement("a", {
      ...
      onClick: onClick,
      "data-id": asset._id
    }), isDeleting && /*#__PURE__*/_react.default.createElement(_FullscreenSpinner.FullscreenSpinner, null)), /*#__PURE__*/_react.default.createElement("div", {
