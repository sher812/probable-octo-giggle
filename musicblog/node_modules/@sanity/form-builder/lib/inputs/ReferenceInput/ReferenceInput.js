...
var _default = (0, _withValuePath.default)((0, _withDocument.default)((_temp = class ReferenceInput extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "search", /*#__PURE__*/function () {
      var _ref = _asyncToGenerator(function* (query) {
        ...
        var options = yield _this.resolveUserDefinedFilter();

        _this.subscriptions.replace('search', onSearch(query, type, options).subscribe({
          next: items => {
            _this.setState(prev => {
    ...
    _defineProperty(this, "renderOpenItemElement", () => {
      ...
      return /*#__PURE__*/_react.default.createElement(_legacyParts.IntentLink, {
  ...
  render() {
    ...
    return /*#__PURE__*/_react.default.createElement(_ChangeIndicator.ChangeIndicatorCompareValueProvider, {
      ...
      space: 2
    }, hasWeakMismatch && /*#__PURE__*/_react.default.createElement(_Alert.Alert, {
      suffix: /*#__PURE__*/_react.default.createElement(_ui.Stack, {
        padding: 2
      }, /*#__PURE__*/_react.default.createElement(_ui.Button, {
        onClick: this.handleFixWeak,
        text: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "Convert to ", /*#__PURE__*/_react.default.createElement("em", null, weakShouldBe), " reference"),
        tone: "caution"
      })),
      title: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "Reference is not ", /*#__PURE__*/_react.default.createElement("em", null, weakShouldBe))
    }, /*#__PURE__*/_react.default.createElement(_ui.Text, {
      as: "p"
    }, "This reference is ", /*#__PURE__*/_react.default.createElement("em", null, weakIs), ". According to the schema it should be", ' ', /*#__PURE__*/_react.default.createElement("em", null, weakShouldBe), ".")), /*#__PURE__*/_react.default.createElement(_legacyParts.SearchableSelect, {
      inputId: this._inputId,
